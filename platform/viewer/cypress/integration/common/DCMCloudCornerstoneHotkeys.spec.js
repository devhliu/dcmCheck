describe('DCMCloud Cornerstone Hotkeys', () => {
  before(() => {
  ...
  it('uses hotkeys "RightArrow" and "LeftArrow" to navigate between multiple viewports', () => {
    ...
    cy.get(
      ':nth-child(2) > .viewport-wrapper > .viewport-element > .DCMCloudCornerstoneViewportOverlay > div.bottom-right.overlay-element > div'
  ...
  //TO-DO: This test is blocked by issue #1095 (https://github.com/DCMCloud/Viewers/issues/1095)
