describe('DCMCloud Download Snapshot File', () => {
  before(() => {
  ...
  it('checks displayed information for Desktop experience', function() {
    ...
    cy.get('[data-cy=modal-header]')
      ...
      .should('contain.text', 'Download / Upload Key Image');
    // Check input fields
  ...
  // TO-DO once issue is fixed: https://github.com/DCMCloud/Viewers/issues/1217
