describe('DCMCloud User Preferences', () => {
  ...
  context('W/L Preset Preferences', function() {
    ...
    // //TODO: Test blocked by issue #1551: https://github.com/DCMCloud/Viewers/issues/1551
    ...
    it('checks if user can change the W/L by triggering different hotkeys with W/L presets on multiple viewports', function() {
      ...
      let second_viewport_overlay =
        'div:nth-child(2) > div > div.viewport-element > div.DCMCloudCornerstoneViewportOverlay > div.bottom-right.overlay-element > div';
