...
const GoogleConnect = () => {
  ...
  var GoogleSecretAccessKey = document.getElementById('GoogleSecretAccessKey').value;
  var GoogleBucketName = document.getElementById('GoogleBucketName').value;
  var GoogledcmcAccessKey = document.getElementById('GoogleDCMCAccesskey').value;
