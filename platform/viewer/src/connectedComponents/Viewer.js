...
class Viewer extends Component {
  ...
  //didupdate for height

  // isToggleSidePanel_componentWillMount() {
  //   console.log(this.state.isToggleSidePanel);
  // }

  // this.state.isToggleSidePanel
  ...
  render() {
    ...
    return (
      <>
        ...
        {/* TOOLBAR */}
        {/* <div className="view-port-container" style={{ height: 'inherit ' }}> */}
