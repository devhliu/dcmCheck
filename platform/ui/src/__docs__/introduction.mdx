...
**@dcmcloud/ui is a collection of components and utilities** that power DCMCloud's
[zero-footprint DICOM viewer](https://github.com/DCMCloud/Viewers)
...
```js
// Add '@dcmcloud/ui' as a dependency
yarn add @dcmcloud/ui

// Import and use components
import { TableList } from '@dcmcloud/ui'
```
...
[demo-url]: https://docs.dcmcloud.org/demo/
<!-- prettier-ignore-end -->
