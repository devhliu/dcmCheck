...
[@dcmcloud/i18n](https://www.npmjs.com/package/@dcmcloud/i18n), where is the main
...
[DCMCloud Namespaces docs](https://docs.dcmcloud.org/viewer/internationalization.html#namespaces).

### How to get right the Namespace of a `@dcmcloud/ui` component?
...
**@dcmcloud/ui** pass down the `t` function trough the custom
[withTranslation HOC](https://github.com/DCMCloud/Viewers/blob/master/platform/ui/src/utils/LanguageProvider.js).

---

## Extending and Overriding languages

[How to Extend languages with @dcmcloud/i18n](https://docs.dcmcloud.org/viewer/internationalization.html#extending-languages-in-dcmcloudi18n)

## Changing the language

The language choosing method is the same implemented in
[DCMCloud Viewers](https://docs.dcmcloud.org/viewer/internationalization.html#changing-the-language)

> You can also change the language of the components displayed in this
> documentation by choosing an option in the
> [Docs Settings](https://react.dcmcloud.org/docs-settings) section.

## Debugging translations

[How to Debug @dcmcloud/i18n](https://docs.dcmcloud.org/viewer/internationalization.html#debugging-translations)
