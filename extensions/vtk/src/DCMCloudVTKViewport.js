...
class DCMCloudVTKViewport extends Component {
  state = {
    volumes: null,
  ...
  static id = 'DCMCloudVTKViewport';

  static init() {
    console.log('DCMCloudVTKViewport init()');
  }

  static destroy() {
    console.log('DCMCloudVTKViewport destroy()');
...
export default DCMCloudVTKViewport;
