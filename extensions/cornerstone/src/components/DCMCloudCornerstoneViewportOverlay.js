...
import './DCMCloudCornerstoneViewportOverlay.css';
import {
  isValidNumber,
...
import { Icon } from '@dcmcloud/ui/src/elements/Icon';
import { Tooltip } from '@dcmcloud/ui/src/components/tooltip';
import { OverlayTrigger } from '@dcmcloud/ui/src/components/overlayTrigger';

class DCMCloudCornerstoneViewportOverlay extends PureComponent {
  static propTypes = {
  ...
  render() {
    ...
    return <div className="DCMCloudCornerstoneViewportOverlay">{normal}</div>;
  }
}

export default DCMCloudCornerstoneViewportOverlay;
