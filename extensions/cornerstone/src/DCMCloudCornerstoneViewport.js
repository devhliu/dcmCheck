...
import DCMCloudCornerstoneViewportOverlay from './components/DCMCloudCornerstoneViewportOverlay';
import ConnectedCornerstoneViewport from './ConnectedCornerstoneViewport';
import DCMCloud from '@dcmcloud/core';
import PropTypes from 'prop-types';
import cornerstone from 'cornerstone-core';

const { StackManager } = DCMCloud.utils;

class DCMCloudCornerstoneViewport extends Component {
  state = {
    viewportData: null,
  };
  ...
  static id = 'DCMCloudCornerstoneViewport';

  static init() {
    console.log('DCMCloudCornerstoneViewport init()');
  }

  static destroy() {
    console.log('DCMCloudCornerstoneViewport destroy()');
  ...
  getViewportData = async (
    ...
    const stack = DCMCloudCornerstoneViewport.getCornerstoneStack(
      studies,
      StudyInstanceUID,
      displaySetInstanceUID,
      SOPInstanceUID,
  ...
  render() {
    ...
    const warningsOverlay = props => {
      return (
        <DCMCloudCornerstoneViewportOverlay
          {...props}
...
export default DCMCloudCornerstoneViewport;
