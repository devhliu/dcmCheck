import { MODULE_TYPES, utils, DICOMWeb } from '@dcmcloud/core';
...
const DCMCloudDicomRTStructSopClassHandler = {
  id: 'DCMCloudDicomRTStructSopClassHandler',
  ...
  getDisplaySetFromSeries: function(
    ...
    rtStructDisplaySet.getSourceDisplaySet = function(
      studies,
...
export default DCMCloudDicomRTStructSopClassHandler;
